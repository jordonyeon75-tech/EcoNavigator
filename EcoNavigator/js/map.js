...
// ... (The rest of your code: Sidebar, Geolocation, etc. remains untouched below) ...
...
$("#apply-filter-btn").on("click", function() {
    ...
    // ... rest of your apply filter logic ...
});

// --- Clear Filter (100% Lag-Free) ---
$("#clear-filter-btn").on("click", function (e) {
    e.preventDefault();

    // 1. Tell the system we are no longer filtering
    window.filterActive = false;
    ...
    // It will ONLY draw markers that fit on the screen right now (zero lag!)
    if (typeof renderStations === 'function') {
        setTimeout(() => {
            renderStations();
        }, 150); // Slight delay ensures map movement finishes first
    }
...
// ============================================
// 1. CONSISTENCY HELPER (Add this at the top or bottom of js/map.js)
// ============================================
...
$("#sidebar-search-trigger").click(function(e) {
    ...
    // Optional: Focus on the search input inside the direction panel if you have one
